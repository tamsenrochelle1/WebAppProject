...
echo <<<_END
	...
	<p class="publisher">Publisher: $row[4]</p><p class="publisher_date">Publication Date: $row[5]</p><p class="item_type">Item Type: $row[3]</p><p class="audiobook_id">Audio Booke ID: $row[0]</p><p class="item_id">Item ID: $row[1]</p>
	
	<a href='cart.php'</a><input type='submit' value="Add to Cart"></a>
	<a href='update.php?item_id=$row[1]'>Update Audio Book</a>
	<a href='delete.php?item_id=$row[1]'>Delete Audio Book</a>
	</pre>
